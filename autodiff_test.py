...
def test_add_two_vars():
    ...
    executor = ad.Executor([grad_x2,grad_x3,y])
    x2_val = 2 * np.array((1,3))
    x3_val = 3 * np.array((1,6))
    grad_x2_val, grad_x3_val, y_val = executor.run(feed_dict = {x2: x2_val, x3: x3_val})
